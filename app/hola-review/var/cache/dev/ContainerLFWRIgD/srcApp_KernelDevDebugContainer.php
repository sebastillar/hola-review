...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/page/1'), [0 => 'ROLE_PAGE_1'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/page/2'), [0 => 'ROLE_PAGE_2'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin'), [0 => 'ROLE_ADMIN'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api', NULL, [0 => 'POST', 1 => 'PUT', 2 => 'DELETE']), [0 => 'ROLE_ADMIN'], NULL);
    ...
    protected function getSecurity_EncoderFactory_GenericService()
    {
        ...
        return $this->privates['security.encoder_factory.generic'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(['App\\Entity\\User' => ['class' => 'Symfony\\Component\\Security\\Core\\Encoder\\NativePasswordEncoder', 'arguments' => [0 => NULL, 1 => NULL, 2 => 5, 3 => '2y']]]);
    }
